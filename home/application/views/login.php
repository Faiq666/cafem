    ...
    <div class="demo">
        <div class="login">
            ...
            <div class="login__form">
                <div>
                    <b>  <h1 style="color: white" > <?php echo $this->session->userdata('error'); $this->session->unset_userdata('error');?> </h1> </b>
                </div>
                ...
                <button type="submit" class="login__submit">Daxil ol</button>
                <p class="login__signup">Şifrənizi unutmusunuz? &nbsp;<a>Daxil ol</a></p>
                </form>
    ...
    <style>
        *, *:before, *:after {
        ...
        .cont {
            position: relative;
            height: 100%;
            background-image: url("http://cdn.cnn.com/cnnnext/dam/assets/190820113330-07-vollpension-vienna-cafe-restricted.jpg");
