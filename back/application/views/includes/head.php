...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url("public"); ?>/libs/bower/material-design-iconic-font/dist/css/material-design-iconic-font.css">
    <!-- build:css /assets/css/app.min.css -->
    <link rel="stylesheet" href="<?php echo base_url("public"); ?>/libs/bower/animate.css/animate.min.css">
    <link rel="stylesheet" href="<?php echo base_url("public"); ?>/libs/bower/fullcalendar/dist/fullcalendar.min.css">
    <link rel="stylesheet" href="<?php echo base_url("public"); ?>/libs/bower/perfect-scrollbar/css/perfect-scrollbar.css">
    ...
    <script src="<?php echo base_url("public"); ?>/libs/bower/breakpoints.js/dist/breakpoints.min.js"></script>
    <script>
        Breakpoints();
    </script>
</head>