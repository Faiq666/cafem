        ...
        <div class="media">
            <div class="media-left">
                <div class="avatar avatar-md avatar-circle">
                    <a href="javascript:void(0)"><img class="img-responsive" src="<?php echo base_url('public/assets') ?>/images/221.jpg" alt="avatar"/></a>
                </div><!-- .avatar -->
            </div>
...
<!--                        <li><a href="dashboard.3.html"><span class="menu-text">Dashboard 3</span></a></li>-->
                ...
                <li class="has-submenu">
                    <a href="<?php echo base_url('Cafe/index') ?>" class="submenu-toggle">
                        <i class="menu-icon zmdi zmdi-layers zmdi-hc-lg"></i>
                        <span class="menu-text">Cafe</span>
                        <span class="label label-warning menu-label">2</span>
                        <i class="menu-caret zmdi zmdi-hc-sm zmdi-chevron-right"></i>
                    </a>
                    <ul class="submenu">
                        <li><a href="<?php echo base_url('Cafe/index') ?>"><span class="menu-text">Cafe_list</span></a></li>
                        <li><a href="<?php echo base_url('Cafe/cafe_add') ?>"><span class="menu-text">Cafe_add</span></a></li>
                    </ul>
                </li>
                <li class="has-submenu">
                    <a href="<?php echo base_url('Menu/index') ?>" class="submenu-toggle">
                        <i class="menu-icon zmdi zmdi-layers zmdi-hc-lg"></i>
                    ...
                    <ul class="submenu">
                        <li><a href="<?php echo base_url('Menu/index') ?>"><span class="menu-text">Menu_list</span></a></li>
