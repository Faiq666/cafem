<!-- build:js <?php echo base_url('public/assets') ?>/js/core.min.js -->
...
<script src="<?php echo base_url('public/assets') ?>/js/library.js"></script>
...
<!--<script src="--><?php //echo base_url('public/assets') ?><!--/js/toggle.js"></script>-->
</body>
</html>