                    ...
                    <div class="media-group dropdown-menu animated flipInY">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <div class="avatar avatar-xs avatar-circle">
                                        <img src="<?php echo base_url('public/assets') ?>/images/221.jpg" alt="">
                        ...
                        <a href="javascript:void(0)" class="media-group-item">
                            <div class="media">
                                <div class="media-left">
                                    <div class="avatar avatar-xs avatar-circle">
                                        <img src="<?php echo base_url('public/assets') ?>/images/205.jpg" alt="">
                        ...
                        <a href="javascript:void(0)" class="media-group-item">
                            <div class="media">
                                <div class="media-left">
                                    <div class="avatar avatar-xs avatar-circle">
                                        <img src="<?php echo base_url('public/assets') ?>/images/207.jpg" alt="">
                        ...
                        <a href="javascript:void(0)" class="media-group-item">
                            <div class="media">
                                <div class="media-left">
                                    <div class="avatar avatar-xs avatar-circle">
                                        <img src="<?php echo base_url('public/assets') ?>/images/211.jpg" alt="">
                                        <i class="status status-away"></i>
                                    </div>
                                </div>
                                <div class="media-body">
