            ...
            <div class="container">
                ...
                <div class="left-side">
                    ...
                    <nav id="navigation" class="style-1">
                        <ul id="responsive">
                            ...
                            <li><a class="current" href="<?php echo base_url('Home')?>">Home</a></li>

                            <li><a href="<?php echo base_url('Home/filter')?>">Listings</a></li>
                ...
                <div class="right-side">
                    <div class="header-widget">
                        <!-- User Menu -->
                        <div class="user-menu">
                            <div class="user-name"><span><img src="<?php echo base_url('public/assets/') ?>images/dashboard-avatar.jpg" alt=""></span>Hi, Tom!</div>
                            <ul>
